...
TEST_F(DISABLED_OpenAIServerFeaturesTest, SampleSelectorMissReturnsEmptyChoices) {
  const HttpResult result =
      client_->post("/v1/sample", make_sample_request("plain text"), get_headers());
...
TEST_F(DISABLED_OpenAIServerFeaturesTest, SampleRejectsUnsupportedSelectorType) {
