...
void CudaGraphPersistentParam::update_llm_decode_metadata_fast_path(
  ...
  xllm::kernel::cuda::LlmDecodeMetadataUpdateParams update_params{
      ...
      params.new_cache_slots.data_ptr<int32_t>(),
      params.kv_seq_lens.data_ptr<int32_t>(),
      params.paged_kv_indptr.data_ptr<int32_t>(),
      params.paged_kv_indices.data_ptr<int32_t>(),
      params.paged_kv_last_page_len.data_ptr<int32_t>(),
      persistent_tokens_.data_ptr<int32_t>(),
      persistent_positions_.data_ptr<int32_t>(),
      persistent_new_cache_slots_.data_ptr<int32_t>(),
      kv_seq_lens_.data_ptr<int32_t>(),
      persistent_kv_seq_lens_delta_.data_ptr<int32_t>(),
      persistent_paged_kv_indptr_.data_ptr<int32_t>(),
  ...
  xllm::kernel::cuda::UpdateLlmDecodeMetadata(update_params, stream);
}
