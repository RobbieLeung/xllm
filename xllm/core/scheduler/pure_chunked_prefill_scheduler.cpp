...
#include "scheduler/pure_chunked_prefill_scheduler.h"
...
namespace xllm {
PureChunkedPrefillScheduler::PureChunkedPrefillScheduler(Engine* engine,
                                                         const Options& options)
    : ContinuousScheduler(engine, options) {}

PureChunkedPrefillScheduler::~PureChunkedPrefillScheduler() {
...
void PureChunkedPrefillScheduler::handle_prefill_requests(
...
void PureChunkedPrefillScheduler::handle_last_step_prefill_requests(
    size_t& latency_budget,
    size_t& estimate_latency,
    size_t& remaining_token_budget,
    size_t& remaining_seq_budget,
...
std::vector<Batch> PureChunkedPrefillScheduler::prepare_batch() {
  Timer timer;
  ...
  // try to finish prefill stage requests as soon as fast as possible
