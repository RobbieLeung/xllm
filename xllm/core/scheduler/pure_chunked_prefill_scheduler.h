...
namespace xllm {
class PureChunkedPrefillScheduler final : public ContinuousScheduler {
 public:
  PureChunkedPrefillScheduler(Engine* engine, const Options& options);
  virtual ~PureChunkedPrefillScheduler();
